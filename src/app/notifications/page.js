...
const MOCK_NOTIFICATIONS = [
  ...
  { id: 5, type: 'dating', icon: FiHeart, color: 'text-pink-400 bg-pink-500/10', title: 'New match on MahberMatch!', body: 'You and Sara have matched. Send a message to start the conversation.', time: '3h ago', read: true },
