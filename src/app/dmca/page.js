      ...
      <div className="max-w-3xl mx-auto px-4 py-16">
        ...
        <div className="prose prose-invert prose-sm max-w-none space-y-8 text-gray-400 leading-relaxed">
          <section>
            ...
            <p>HabeshaHub, Inc. (&ldquo;HabeshaHub&rdquo;) respects the intellectual property rights of others and expects its users to do the same. In accordance with the Digital Millennium Copyright Act of 1998 (&ldquo;DMCA&rdquo;), we will respond expeditiously to claims of copyright infringement committed using our platform.</p>
          </section>

          <section>
            <h2 className="text-xl font-bold text-white">2. Reporting Copyright Infringement</h2>
            <p>If you believe that content on HabeshaHub infringes your copyright, please send a DMCA takedown notice to our designated agent containing the following information:</p>
          ...
          <section>
            ...
            <div className="bg-gray-900 rounded-xl p-4 border border-gray-800">
              <p className="text-white font-medium">HabeshaHub, Inc.</p>
              <p>DMCA Agent</p>
              <p>Seattle, Washington, USA</p>
              <p>Email: <a href="mailto:dmca@habeshahub.com" className="text-amber-400 hover:text-amber-300">dmca@habeshahub.com</a></p>
            </div>
          </section>
          ...
          <section>
            ...
            <p>HabeshaHub will terminate, in appropriate circumstances, the accounts of users who are repeat infringers of copyright. We reserve the right to remove any content and terminate any account at our sole discretion, without prior notice.</p>
          </section>

          <section>
            <h2 className="text-xl font-bold text-white">6. Protecting Our IP</h2>
            <p>The HabeshaHub platform, including all source code, designs, logos, trademarks, and original content, is the exclusive intellectual property of HabeshaHub, Inc., protected under U.S. and international copyright law. Unauthorized reproduction, distribution, or creation of derivative works is strictly prohibited and will be pursued to the fullest extent of the law.</p>
          </section>
        </div>
      </div>
      <Footer />
